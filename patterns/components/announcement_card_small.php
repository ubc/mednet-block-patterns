...
<div class="wp-block-query announcement_card_small">
    <!-- wp:post-template -->
    ...
    <div class="wp-block-columns are-vertically-aligned-center">
        ...
        <div
            ...
            style="flex-basis: 60%"
        >
            <!-- wp:post-title {"textAlign":"left","isLink":true,"linkTarget":"_blank","style":{"color":{"text":"#0055b7"},"typography":{"fontSize":"18px"}}} /-->
        </div>
        <!-- /wp:column -->
    </div>
    <!-- /wp:columns -->
