...
<div class="wp-block-column is-vertically-aligned-center" style="flex-basis:75%"><!-- wp:post-title {"textAlign":"left","isLink":true,"linkTarget":"_blank","style":{"color":{"text":"#0055b7"},"typography":{"fontSize":"18px"}}} /--></div>
<!-- /wp:column --></div>
<!-- /wp:columns -->
