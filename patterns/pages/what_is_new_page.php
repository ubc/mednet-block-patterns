    ...
    <div class="wp-block-column" style="flex-basis: 50%">
      ...
      <div class="wp-block-group">
        ...
        <div class="wp-block-query featured-announcement">
          ...
          <!-- wp:paragraph -->
          <p>
            One-on-One One-on-One is a series aimed at getting ‘behind the
            scenes’ with senior leadership in the Faculty of
            Medicine.&nbsp;One-on-One One-on-One is a series aimed at getting
            ‘behind the scenes’ with senior leadership in the Faculty of
            Medicine.
          </p>
          <!-- /wp:paragraph -->
          <!-- /wp:post-template -->
      ...
      <div class="wp-block-buttons">
        ...
        <div class="wp-block-button is-style-blue-btn">
          <a class="wp-block-button__link" href="/">See What's New</a>
        </div>
        <!-- /wp:button -->
      </div>
      <!-- /wp:buttons -->
