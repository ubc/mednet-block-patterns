...
<div class="wp-block-group homepage">
    ...
    <div class="wp-block-column" style="flex-basis: 260px">
      ...
      <div class="wp-block-group">
        ...
        <ul class="quicklinks_list">
          ...
          <li>
            <a rel="noreferrer noopener" href="/" target="_blank">Workday</a>
          </li>
          <li>
            <a rel="noreferrer noopener" href="/" target="_blank">TTPS</a>
          </li>
          <li>
      ...
      >
        ...
        <p class="has-text-color" style="color: #002145; font-size: 14px">
        ...
        <p class="has-text-color" style="color: #002145; font-size: 16px">
          <a
            href="/resource"
            data-type="URL"
            data-id="/resource"
  ...
  <div class="wp-block-columns">
    ...
    <div class="wp-block-column" style="flex-basis: 50%">
      <!-- wp:group {"className":"content_card_with_overlay"} -->
      <div class="wp-block-group content_card_with_overlay">
        <!-- wp:group -->
        <div class="wp-block-group">
          ...
          <figure
            class="wp-block-image size-large is-resized is-style-default overlay_image"
          >
            <img
              src="/wp-content/plugins/mednet-block-patterns/includes/assets/images/svgs/Pattern_Overlay.svg"
              alt=""
              width="457"
              height="268"
            />
        ...
        <p
          class="has-text-color"
          style="color: #0055b7; font-size: 28px; letter-spacing: -0.14px"
        >
          <a
        ...
        <p class="has-text-color" style="color: #002145; font-size: 16px">
          Learn more about the Faculty&rsquo;s commitment and actions towards
    ...
    <div class="wp-block-column" style="flex-basis: 25%">
      ...
      <div class="wp-block-group pathways_feature_block">
        ...
        <!-- wp:group -->
        <div class="wp-block-group">
          <!-- wp:image {"id":466,"sizeSlug":"full","linkDestination":"none","className":"is-style-default"} -->
          <figure class="wp-block-image size-full is-style-default">
            <img
              src="https://via.placeholder.com/150/002145/ffffff/"
              alt=""
