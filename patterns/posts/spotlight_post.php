...
<div class="wp-block-group spotlight_post_inline_photo">
    ...
    <div class="wp-block-columns">
        ...
        <div class="wp-block-column" style="flex-basis: 33.33%">
            ...
            <!-- wp:buttons -->
            <div class="wp-block-buttons">
                <!-- wp:button {"style":{"border":{"radius":"0px"},"color":{"background":"#0055b7"},"typography":{"fontSize":"16px"}},"className":"is-style-fill"} -->
                <div
            ...
            <h2 style="font-size: 24px; letter-spacing: -0.24px">
                Get Involved
            </h2>
            <!-- /wp:heading -->
